export const generationZhCN = {
  classroom: {
    ...
    teacherView: '教师端',
    studentView: '学生端',
    copyStudentLink: '复制学生端链接',
    studentLinkCopied: '学生端链接已复制',
    studentLinkCopyFailed: '复制学生端链接失败',
    deleteSuccess: '课堂已删除',
    deleteFailed: '删除课堂失败',
...
export const generationEnUS = {
  classroom: {
    ...
    studentLinkCopied: 'Student link copied',
    studentLinkCopyFailed: 'Failed to copy student link',
    deleteSuccess: 'Classroom deleted',
